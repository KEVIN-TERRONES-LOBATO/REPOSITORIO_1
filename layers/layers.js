...
//ol.proj.get("EPSG:4326").setExtent([-88.520431, -18.402511, -52.004942, 0.827539]);
var wms_layers = [];
...
lyr_departamento_sencico_1.set('fieldImages', {'ID_0': 'Hidden', 'ISO': 'Hidden', 'NAME_0': 'Hidden', 'ID_1': 'Hidden', 'NAME_1': 'TextEdit', 'Lista': 'Hidden', });
lyr_departamento_sencico_1.set('fieldLabels', {'NAME_1': 'inline label - always visible', });
